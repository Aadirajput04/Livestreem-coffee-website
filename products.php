...
<head>
    ...
    <title>Products | Livestreem Coffee</title>
</head>
...
<body>
    ...
    <div class="main-manu-page side-padding page-width">
        ...
        <a class="load-more" href="#"> Load More <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28"
                fill="none">
                <path
